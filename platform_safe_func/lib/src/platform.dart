...
import 'package:path/path.dart' if (dart.library.html) 'web.dart' as path_impl;
...
String joinPath(
  ...
  return path_impl.join(part1, part2, part3, part4, part5, part6, part7, part8);
}

String basenameOfPath(String path) => path_impl.basename(path);

String extensionOfPath(String path, [int level = 1]) => path_impl.extension(path, level);
